package com.quangnv.broadcastreceiverdemo.services;
...
import com.quangnv.broadcastreceiverdemo.MainActivity;
import com.quangnv.broadcastreceiverdemo.R;
import com.quangnv.broadcastreceiverdemo.data.Audio;
import com.quangnv.broadcastreceiverdemo.data.AudioTask;
import com.quangnv.broadcastreceiverdemo.data.TaskListener;
...
public class AudioService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    @Override
    public void onProgressUpdateTask(Audio audio) {
        postUpdateAudioTask(audio);
        mAudios.add(audio);
    }

    @Override
    public void onCompleteTask(List<Audio> audios) {
    ...
    private void initAudio(Audio audio) {
        initMediaPlayer();
        Uri uri = Uri.parse(audio.getPath());
        try {
    ...
    private void postTitleAudio() {
        mAudioListener.onTitleAudio(mAudios.get(currentAudioPosition).getName());
    }
    ...
    private void postUpdateAudios(List<Audio> audios) {
        mAudioListener.onUpdateAudios(audios);
    }
    ...
    private void updateNotification(String intentAction) {
        ...
        switch (intentAction) {
            case ACTION_PLAY:
                ...
                remoteViewLayout.setOnClickPendingIntent(R.id.button_play, pauseStartPendingIntent);
                break;
            case ACTION_PAUSE:
                remoteViewLayout = new RemoteViews(getPackageName(), R.layout.custom_notification_pause);
                remoteViewLayout.setOnClickPendingIntent(R.id.button_pause, pauseStartPendingIntent);
                break;
        }

        remoteViewLayout.setOnClickPendingIntent(R.id.button_next, nextPendingIntent);
        remoteViewLayout.setOnClickPendingIntent(R.id.button_previous, previousPendingIntent);
